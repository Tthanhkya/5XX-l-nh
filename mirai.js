...
function checkBan(checkban) {
    ...
    logger(global.getText('mirai', 'checkListGban'), '[ Zns🐰 ]'), global.checkBan = !![];
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ Zns🐰 ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            if (isNaN(_0x4244d8) || _0x4244d8.length < 6 || _0x4244d8.length > 6) 
                ...
                if (_0x360aa8 !== _0x4244d8) return console.log(global.getText('mirai', 'codeInputExpired'));
                    ...
                    logger(global.getText('mirai', 'unbanDeviceSuccess'), '[ Zns🐰 ]');
                }
            });
        });
        return;
    ...
    return axios.get('https://raw.githubusercontent.com/Kenne400k/mirai/main/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/Kenne400k/mirai/main/data.json').then(json => {
            ...
            //  return logger('BYPASS Zns!!!', '[ Zns🐰 ]'), 
            // process.exit(0);
            logger(json.data[Math['floor'](Math['random']() * json.data.length)], '[ Zns🐰 ]');
...
function onBot({ models: botModel }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
        if (loginError) return logger(JSON.stringify(loginError), `Xin vui lòng xóa lệnh đó hoặc thêm code vào`);
        ...
        if (!global.checkBan) logger(global.getText('mirai', 'warningSourceCode'), '[ Zns🐰 ]');
        ...
        //         return logger(global.getText('mirai', 'refreshListen'), '[ Zns🐰 ]');
        // }, 600000);
    });
}
//////////////////////////////////////////////
...
(async() => {
    try {
        ...
        logger(global.getText('mirai', 'successConnectDatabase'), '[ Zns🐰 ]');
        const botData = {};
